...
//             interpreter.SetMMUBypass(BypassMMU);
//         }
...
//             if (inst.IsBranch)
//             {
//                 BU_TargetAddress = m_FallbackInterpreter.BU_TargetAddress;
//                 BU_ExecuteBranchDelay = m_FallbackInterpreter.BU_ExecuteBranchDelay;
//                 BU_NullifyNext = m_FallbackInterpreter.BU_NullifyNext;

//                 if (m_FallbackInterpreter.BU_ConditionalPending || m_FallbackInterpreter.BU_UnconditionalPending)
//                 {
//                     block.SetJump((uint)m_FallbackInterpreter.BU_TargetAddress);
//                     m_FallbackInterpreter.ClearBranchState();
//                 }
//                 else
//                 {
//                     block.ClearJump();
