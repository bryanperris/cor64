...
namespace cor64.BassSharp.Eval
{
    internal static class Parser
    {
        ...
        private static Node ternary(ref Node node, ref String s, Node.Type type, int seek, int depth)
        {
            ...
            if (s[0] != ':')
                throw new InvalidOperationException("Mismatched ternary");
        ...
        public static void Parse(ref Node node, ref String s, int depth)
        {
            ...
            if (s[0] == '(' && node.Link.Count == 0) {
                ...
                if (s[0] != ')')
                    throw new InvalidOperationException("Mismatched group");
            ...
            while (s.Length > 0) {
                ...
                if (s[0] == '(' && !p()) {
                    ...
                    if (s[0] != ')')
                        throw new InvalidOperationException("Mismatched function");
                ...
                if (s[0] == '[') {
                    ...
                    if (s[0] != ']')
                        throw new InvalidOperationException("Mismatched subscript");
                ...
                throw new InvalidOperationException("Unrecognized terminal");
            }
        }
