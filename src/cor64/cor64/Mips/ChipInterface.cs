...
{
    public class ChipInterface : PerpherialDevice
    {
        ...
        public ChipInterface(N64MemoryController controller) : base(controller, 0x100000)
        {
            AppendDevice(m_Mode, m_Version, m_Interrupt, m_Mask);
        }

        public void SetVersion(uint value)
        {
            m_Version.WritePtr.AsType_32(value);
        }
