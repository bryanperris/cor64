...
namespace Tests.Cpu
{
    ...
    public class DisassemblerTests : BaseTest
    {
        ...
        private static IList<cor64.BassSharp.Table.Opcode> GenerateOpcodeList(HashSet<String> blacklist)
        {
            var assembler = new N64Assembler();
        ...
        private static void _TestOpcodes(Action<cor64.BassSharp.Table.Opcode, DecodedInstruction> validator)
        {
